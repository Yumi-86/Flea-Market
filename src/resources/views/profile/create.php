...
<div class="profile-page">
    <h2 class="profile-page__title">プロフィール設定</h2>

    <form action="{{ route('profile.store') }}" class="profile-form" novalidate enctype="multipart/form-data">
        @csrf

        <div class="profile-form__image-section">
            <img src="{{ asset('images/default-user.png') }}" alt="プロフィール画像" class="profile-form__image-preview" id="imagePreview">
        ...
        <div class="profile-form__group form__group">
            ...
            <input type="text" name="postal_code" class="profile-form__input form__input" value="{{ old('postal_code') }}" id="postal_code">
            @error('postal_code')
            <div class="profile-form__error form__error">{{ $message }}</div>
            @enderror
        </div>
        <div class="profile-form__group form__group">
            ...
            <input type="text" name="address" class="profile-form__input form__input" value="{{ old('address') }}" id="address">
            @error('address')
            <div class="profile-form__error form__error">{{ $message }}</div>
            @enderror
        </div>
        <div class="profile-form__group form__group">
            ...
            <input type="text" name="building" class="profile-form__input form__input" value="{{ old('building') }}" id="building">
            @error('building')
            <div class="profile-form__error form__error">{{ $message }}</div>
            @enderror
        </div>

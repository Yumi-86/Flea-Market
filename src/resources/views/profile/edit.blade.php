...
<div class="profile-page">
    ...
    <form action="{{ route('profile.update') }}" class="profile-form" novalidate enctype="multipart/form-data">
        @csrf
        @method('PATCH')

        <div class="profile-form__image-section">
            <img src="{{ old('profile_image') ? 
            asset('storage/' . old('profile_image')) : 
            ($profile->profile_image ? asset('storage/' . $profile->profile_image) : asset('images/default-user.png')) }}"
